...
fun main() {
    ...
    onStart {
        ...
        * Para a tecla backspace é desenhado um novo objeto Game com base no último elemento da lista undo,
        * correspondendo à última posição do homem e das caixas, bem como da posição anterior tomada pelo homem,
